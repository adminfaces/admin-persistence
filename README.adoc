...
. *Controller*
Now on the controller layer (JSF managede beans) you have to extend *CrudMB* and provide your service to JSF managed beans and then enable CRUD support out of the box:
+
[source,java]
----
@Named
